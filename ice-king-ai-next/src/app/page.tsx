    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 relative">
      ...
      <section className="relative px-4 py-16 md:py-24 golden-spotlight">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Premium Badge */}
          <div className="inline-flex items-center gap-2 mx-8 bg-slate-800/50 border border-yellow-400/30 rounded-full px-6 py-3 mb-4 golden-border-glow golden-sparkle">
            <Sparkles className="w-5 h-5 text-yellow-400 golden-icon-glow" />
            <span className="text-yellow-400 font-medium">从灵感乍现，到爆款刷屏</span>
          </div>

          {/* Model Info Badge - 可配置的模型信息 */}
          <ModelInfoBadge />
